  ...
  const game = {
    ...
    loop: () => {
      ...
      if (!stopped) {
        ...
        ctx.fillText("(esc) reset", 10, 570);
        ctx.fillText("(space) pause", 10, 590);
      }
      ...
      if (stopped) {
        ...
        ctx.fillText("press ARROW KEYS to START...", 24, 550);
      }

      ctx.fillStyle = 'rgba(250,250,250,0.6)';;
      ctx.font = "bold small-caps 16px Helvetica";
      ctx.fillText("points: " + points, 500, 40);
      ctx.fillText("top: " + pointsMax, 500, 60);
